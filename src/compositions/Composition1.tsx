...
export default function Composition1(props: Props) {
		...
		<AbsoluteFill className="items-center justify-center">
			<div className='relative flex flex-col items-center justify-center w-full h-full'>
				...
				<Subtitle
					...
					desappearFrame={180}
				>
					Bem-vindo à Jardins Verdejantes, onde a natureza encontra a arte do paisagismo.
				</Subtitle>
				<Audio
					src={staticFile('voice1.mp3')}
					startFrom={0}
					endAt={180}
					volume={0.5}
				/>
